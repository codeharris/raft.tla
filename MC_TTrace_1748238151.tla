...
_inv ==
    ~(
        ...
        /\
        messages = (([mterm |-> 2, mtype |-> AppendEntriesResponse, msource |-> r3, mdest |-> r2, msuccess |-> TRUE, mmatchIndex |-> 1] :> 0 @@ [mterm |-> 2, mtype |-> AppendEntriesResponse, msource |-> r3, mdest |-> r2, msuccess |-> TRUE, mmatchIndex |-> 2] :> 1 @@ [mterm |-> 2, mtype |-> AppendEntriesResponse, msource |-> r4, mdest |-> r2, msuccess |-> TRUE, mmatchIndex |-> 1] :> 1 @@ [mterm |-> 2, mtype |-> AppendEntriesRequest, msource |-> r2, mdest |-> r3, mprevLogIndex |-> 0, mprevLogTerm |-> 0, mentries |-> <<[term |-> 2, value |-> v1]>>, mcommitIndex |-> 0] :> 0 @@ [mterm |-> 2, mtype |-> AppendEntriesRequest, msource |-> r2, mdest |-> r3, mprevLogIndex |-> 1, mprevLogTerm |-> 2, mentries |-> <<[term |-> 2, value |-> v2]>>, mcommitIndex |-> 1] :> 0 @@ [mterm |-> 2, mtype |-> AppendEntriesRequest, msource |-> r2, mdest |-> r4, mprevLogIndex |-> 0, mprevLogTerm |-> 0, mentries |-> <<[term |-> 2, value |-> v1]>>, mcommitIndex |-> 1] :> 0))
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("MC_TTrace_1748238151.json", _TETrace)
...
\*
\*trace == IODeserialize("MC_TTrace_1748238151.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([votedFor |-> (r1 :> r2 @@ r2 :> Nil @@ r3 :> r2 @@ r4 :> r2),log |-> (r1 :> <<>> @@ r2 :> <<[term |-> 2, value |-> v1, payload |-> v1], [term |-> 2, value |-> v2, payload |-> v2]>> @@ r3 :> <<>> @@ r4 :> <<>>),voterLog |-> (r1 :> <<>> @@ r2 :> (r3 :> <<>> @@ r4 :> <<>>) @@ r3 :> <<>> @@ r4 :> <<>>),nextIndex |-> (r1 :> (r1 :> 1 @@ r2 :> 1 @@ r3 :> 1 @@ r4 :> 1) @@ r2 :> (r1 :> 1 @@ r2 :> 1 @@ r3 :> 1 @@ r4 :> 1) @@ r3 :> (r1 :> 1 @@ r2 :> 1 @@ r3 :> 1 @@ r4 :> 1) @@ r4 :> (r1 :> 1 @@ r2 :> 1 @@ r3 :> 1 @@ r4 :> 1)),Servers |-> {r2, r3, r4},switchIndex |-> r1,maxc |-> 2,switchBuffer |-> (v1 :> [term |-> 2, value |-> v1, payload |-> v1] @@ v2 :> [term |-> 2, value |-> v2, payload |-> v2]),currentTerm |-> (r1 :> 2 @@ r2 :> 2 @@ r3 :> 2 @@ r4 :> 2),entryCommitStats |-> (<<1, 2>> :> [sentCount |-> 1, ackCount |-> 0, committed |-> FALSE] @@ <<2, 2>> :> [sentCount |-> 0, ackCount |-> 0, committed |-> FALSE]),votesResponded |-> (r1 :> {} @@ r2 :> {r3, r4} @@ r3 :> {} @@ r4 :> {}),votesGranted |-> (r1 :> {} @@ r2 :> {r3, r4} @@ r3 :> {} @@ r4 :> {}),messages |-> ([mterm |-> 2, mtype |-> AppendEntriesRequest, msource |-> r2, mdest |-> r3, mprevLogIndex |-> 0, mprevLogTerm |-> 0, mentries |-> <<[term |-> 2, value |-> v1]>>, mcommitIndex |-> 0] :> 1),matchIndex |-> (r1 :> (r1 :> 0 @@ r2 :> 0 @@ r3 :> 0 @@ r4 :> 0) @@ r2 :> (r1 :> 0 @@ r2 :> 0 @@ r3 :> 0 @@ r4 :> 0) @@ r3 :> (r1 :> 0 @@ r2 :> 0 @@ r3 :> 0 @@ r4 :> 0) @@ r4 :> (r1 :> 0 @@ r2 :> 0 @@ r3 :> 0 @@ r4 :> 0)),switchSentRecord |-> (r1 :> {} @@ r2 :> {<<v1, 2>>, <<v2, 2>>} @@ r3 :> {<<v1, 2>>, <<v2, 2>>} @@ r4 :> {<<v1, 2>>}),state |-> (r1 :> Switch @@ r2 :> Leader @@ r3 :> Follower @@ r4 :> Follower),leaderCount |-> (r1 :> 0 @@ r2 :> 1 @@ r3 :> 0 @@ r4 :> 0),unorderedRequest |-> (r1 :> {} @@ r2 :> {} @@ r3 :> {v1, v2} @@ r4 :> {v1}),commitIndex |-> (r1 :> 0 @@ r2 :> 0 @@ r3 :> 0 @@ r4 :> 0)]),
    ...
    ([votedFor |-> (r1 :> r2 @@ r2 :> Nil @@ r3 :> r2 @@ r4 :> r2),log |-> (r1 :> <<>> @@ r2 :> <<[term |-> 2, value |-> v1, payload |-> v1], [term |-> 2, value |-> v2, payload |-> v2]>> @@ r3 :> <<[term |-> 2, value |-> v1, payload |-> v1]>> @@ r4 :> <<>>),voterLog |-> (r1 :> <<>> @@ r2 :> (r3 :> <<>> @@ r4 :> <<>>) @@ r3 :> <<>> @@ r4 :> <<>>),nextIndex |-> (r1 :> (r1 :> 1 @@ r2 :> 1 @@ r3 :> 1 @@ r4 :> 1) @@ r2 :> (r1 :> 1 @@ r2 :> 1 @@ r3 :> 2 @@ r4 :> 1) @@ r3 :> (r1 :> 1 @@ r2 :> 1 @@ r3 :> 1 @@ r4 :> 1) @@ r4 :> (r1 :> 1 @@ r2 :> 1 @@ r3 :> 1 @@ r4 :> 1)),Servers |-> {r2, r3, r4},switchIndex |-> r1,maxc |-> 2,switchBuffer |-> (v1 :> [term |-> 2, value |-> v1, payload |-> v1] @@ v2 :> [term |-> 2, value |-> v2, payload |-> v2]),currentTerm |-> (r1 :> 2 @@ r2 :> 2 @@ r3 :> 2 @@ r4 :> 2),entryCommitStats |-> (<<1, 2>> :> [sentCount |-> 1, ackCount |-> 1, committed |-> TRUE] @@ <<2, 2>> :> [sentCount |-> 1, ackCount |-> 0, committed |-> FALSE]),votesResponded |-> (r1 :> {} @@ r2 :> {r3, r4} @@ r3 :> {} @@ r4 :> {}),votesGranted |-> (r1 :> {} @@ r2 :> {r3, r4} @@ r3 :> {} @@ r4 :> {}),messages |-> ([mterm |-> 2, mtype |-> AppendEntriesResponse, msource |-> r3, mdest |-> r2, msuccess |-> TRUE, mmatchIndex |-> 1] :> 0 @@ [mterm |-> 2, mtype |-> AppendEntriesRequest, msource |-> r2, mdest |-> r3, mprevLogIndex |-> 0, mprevLogTerm |-> 0, mentries |-> <<[term |-> 2, value |-> v1]>>, mcommitIndex |-> 0] :> 0 @@ [mterm |-> 2, mtype |-> AppendEntriesRequest, msource |-> r2, mdest |-> r3, mprevLogIndex |-> 1, mprevLogTerm |-> 2, mentries |-> <<[term |-> 2, value |-> v2]>>, mcommitIndex |-> 1] :> 1 @@ [mterm |-> 2, mtype |-> AppendEntriesRequest, msource |-> r2, mdest |-> r4, mprevLogIndex |-> 0, mprevLogTerm |-> 0, mentries |-> <<[term |-> 2, value |-> v1]>>, mcommitIndex |-> 1] :> 1),matchIndex |-> (r1 :> (r1 :> 0 @@ r2 :> 0 @@ r3 :> 0 @@ r4 :> 0) @@ r2 :> (r1 :> 0 @@ r2 :> 0 @@ r3 :> 1 @@ r4 :> 0) @@ r3 :> (r1 :> 0 @@ r2 :> 0 @@ r3 :> 0 @@ r4 :> 0) @@ r4 :> (r1 :> 0 @@ r2 :> 0 @@ r3 :> 0 @@ r4 :> 0)),switchSentRecord |-> (r1 :> {} @@ r2 :> {<<v1, 2>>, <<v2, 2>>} @@ r3 :> {<<v1, 2>>, <<v2, 2>>} @@ r4 :> {<<v1, 2>>}),state |-> (r1 :> Switch @@ r2 :> Leader @@ r3 :> Follower @@ r4 :> Follower),leaderCount |-> (r1 :> 0 @@ r2 :> 1 @@ r3 :> 0 @@ r4 :> 0),unorderedRequest |-> (r1 :> {} @@ r2 :> {} @@ r3 :> {v2} @@ r4 :> {v1}),commitIndex |-> (r1 :> 0 @@ r2 :> 1 @@ r3 :> 0 @@ r4 :> 0)]),
    ...
    ([votedFor |-> (r1 :> r2 @@ r2 :> Nil @@ r3 :> r2 @@ r4 :> r2),log |-> (r1 :> <<>> @@ r2 :> <<[term |-> 2, value |-> v1, payload |-> v1], [term |-> 2, value |-> v2, payload |-> v2]>> @@ r3 :> <<[term |-> 2, value |-> v1, payload |-> v1], [term |-> 2, value |-> v2, payload |-> v2]>> @@ r4 :> <<>>),voterLog |-> (r1 :> <<>> @@ r2 :> (r3 :> <<>> @@ r4 :> <<>>) @@ r3 :> <<>> @@ r4 :> <<>>),nextIndex |-> (r1 :> (r1 :> 1 @@ r2 :> 1 @@ r3 :> 1 @@ r4 :> 1) @@ r2 :> (r1 :> 1 @@ r2 :> 1 @@ r3 :> 2 @@ r4 :> 1) @@ r3 :> (r1 :> 1 @@ r2 :> 1 @@ r3 :> 1 @@ r4 :> 1) @@ r4 :> (r1 :> 1 @@ r2 :> 1 @@ r3 :> 1 @@ r4 :> 1)),Servers |-> {r2, r3, r4},switchIndex |-> r1,maxc |-> 2,switchBuffer |-> (v1 :> [term |-> 2, value |-> v1, payload |-> v1] @@ v2 :> [term |-> 2, value |-> v2, payload |-> v2]),currentTerm |-> (r1 :> 2 @@ r2 :> 2 @@ r3 :> 2 @@ r4 :> 2),entryCommitStats |-> (<<1, 2>> :> [sentCount |-> 1, ackCount |-> 1, committed |-> TRUE] @@ <<2, 2>> :> [sentCount |-> 1, ackCount |-> 0, committed |-> FALSE]),votesResponded |-> (r1 :> {} @@ r2 :> {r3, r4} @@ r3 :> {} @@ r4 :> {}),votesGranted |-> (r1 :> {} @@ r2 :> {r3, r4} @@ r3 :> {} @@ r4 :> {}),messages |-> ([mterm |-> 2, mtype |-> AppendEntriesResponse, msource |-> r3, mdest |-> r2, msuccess |-> TRUE, mmatchIndex |-> 1] :> 0 @@ [mterm |-> 2, mtype |-> AppendEntriesResponse, msource |-> r3, mdest |-> r2, msuccess |-> TRUE, mmatchIndex |-> 2] :> 1 @@ [mterm |-> 2, mtype |-> AppendEntriesRequest, msource |-> r2, mdest |-> r3, mprevLogIndex |-> 0, mprevLogTerm |-> 0, mentries |-> <<[term |-> 2, value |-> v1]>>, mcommitIndex |-> 0] :> 0 @@ [mterm |-> 2, mtype |-> AppendEntriesRequest, msource |-> r2, mdest |-> r3, mprevLogIndex |-> 1, mprevLogTerm |-> 2, mentries |-> <<[term |-> 2, value |-> v2]>>, mcommitIndex |-> 1] :> 0 @@ [mterm |-> 2, mtype |-> AppendEntriesRequest, msource |-> r2, mdest |-> r4, mprevLogIndex |-> 0, mprevLogTerm |-> 0, mentries |-> <<[term |-> 2, value |-> v1]>>, mcommitIndex |-> 1] :> 1),matchIndex |-> (r1 :> (r1 :> 0 @@ r2 :> 0 @@ r3 :> 0 @@ r4 :> 0) @@ r2 :> (r1 :> 0 @@ r2 :> 0 @@ r3 :> 1 @@ r4 :> 0) @@ r3 :> (r1 :> 0 @@ r2 :> 0 @@ r3 :> 0 @@ r4 :> 0) @@ r4 :> (r1 :> 0 @@ r2 :> 0 @@ r3 :> 0 @@ r4 :> 0)),switchSentRecord |-> (r1 :> {} @@ r2 :> {<<v1, 2>>, <<v2, 2>>} @@ r3 :> {<<v1, 2>>, <<v2, 2>>} @@ r4 :> {<<v1, 2>>}),state |-> (r1 :> Switch @@ r2 :> Leader @@ r3 :> Follower @@ r4 :> Follower),leaderCount |-> (r1 :> 0 @@ r2 :> 1 @@ r3 :> 0 @@ r4 :> 0),unorderedRequest |-> (r1 :> {} @@ r2 :> {} @@ r3 :> {} @@ r4 :> {v1}),commitIndex |-> (r1 :> 0 @@ r2 :> 1 @@ r3 :> 1 @@ r4 :> 0)]),
    ...
    ([votedFor |-> (r1 :> r2 @@ r2 :> Nil @@ r3 :> r2 @@ r4 :> r2),log |-> (r1 :> <<>> @@ r2 :> <<[term |-> 2, value |-> v1, payload |-> v1], [term |-> 2, value |-> v2, payload |-> v2]>> @@ r3 :> <<[term |-> 2, value |-> v1, payload |-> v1], [term |-> 2, value |-> v2, payload |-> v2]>> @@ r4 :> <<[term |-> 2, value |-> v1, payload |-> v1]>>),voterLog |-> (r1 :> <<>> @@ r2 :> (r3 :> <<>> @@ r4 :> <<>>) @@ r3 :> <<>> @@ r4 :> <<>>),nextIndex |-> (r1 :> (r1 :> 1 @@ r2 :> 1 @@ r3 :> 1 @@ r4 :> 1) @@ r2 :> (r1 :> 1 @@ r2 :> 1 @@ r3 :> 2 @@ r4 :> 1) @@ r3 :> (r1 :> 1 @@ r2 :> 1 @@ r3 :> 1 @@ r4 :> 1) @@ r4 :> (r1 :> 1 @@ r2 :> 1 @@ r3 :> 1 @@ r4 :> 1)),Servers |-> {r2, r3, r4},switchIndex |-> r1,maxc |-> 2,switchBuffer |-> (v1 :> [term |-> 2, value |-> v1, payload |-> v1] @@ v2 :> [term |-> 2, value |-> v2, payload |-> v2]),currentTerm |-> (r1 :> 2 @@ r2 :> 2 @@ r3 :> 2 @@ r4 :> 2),entryCommitStats |-> (<<1, 2>> :> [sentCount |-> 1, ackCount |-> 1, committed |-> TRUE] @@ <<2, 2>> :> [sentCount |-> 1, ackCount |-> 0, committed |-> FALSE]),votesResponded |-> (r1 :> {} @@ r2 :> {r3, r4} @@ r3 :> {} @@ r4 :> {}),votesGranted |-> (r1 :> {} @@ r2 :> {r3, r4} @@ r3 :> {} @@ r4 :> {}),messages |-> ([mterm |-> 2, mtype |-> AppendEntriesResponse, msource |-> r3, mdest |-> r2, msuccess |-> TRUE, mmatchIndex |-> 1] :> 0 @@ [mterm |-> 2, mtype |-> AppendEntriesResponse, msource |-> r3, mdest |-> r2, msuccess |-> TRUE, mmatchIndex |-> 2] :> 1 @@ [mterm |-> 2, mtype |-> AppendEntriesResponse, msource |-> r4, mdest |-> r2, msuccess |-> TRUE, mmatchIndex |-> 1] :> 1 @@ [mterm |-> 2, mtype |-> AppendEntriesRequest, msource |-> r2, mdest |-> r3, mprevLogIndex |-> 0, mprevLogTerm |-> 0, mentries |-> <<[term |-> 2, value |-> v1]>>, mcommitIndex |-> 0] :> 0 @@ [mterm |-> 2, mtype |-> AppendEntriesRequest, msource |-> r2, mdest |-> r3, mprevLogIndex |-> 1, mprevLogTerm |-> 2, mentries |-> <<[term |-> 2, value |-> v2]>>, mcommitIndex |-> 1] :> 0 @@ [mterm |-> 2, mtype |-> AppendEntriesRequest, msource |-> r2, mdest |-> r4, mprevLogIndex |-> 0, mprevLogTerm |-> 0, mentries |-> <<[term |-> 2, value |-> v1]>>, mcommitIndex |-> 1] :> 0),matchIndex |-> (r1 :> (r1 :> 0 @@ r2 :> 0 @@ r3 :> 0 @@ r4 :> 0) @@ r2 :> (r1 :> 0 @@ r2 :> 0 @@ r3 :> 1 @@ r4 :> 0) @@ r3 :> (r1 :> 0 @@ r2 :> 0 @@ r3 :> 0 @@ r4 :> 0) @@ r4 :> (r1 :> 0 @@ r2 :> 0 @@ r3 :> 0 @@ r4 :> 0)),switchSentRecord |-> (r1 :> {} @@ r2 :> {<<v1, 2>>, <<v2, 2>>} @@ r3 :> {<<v1, 2>>, <<v2, 2>>} @@ r4 :> {<<v1, 2>>}),state |-> (r1 :> Switch @@ r2 :> Leader @@ r3 :> Follower @@ r4 :> Follower),leaderCount |-> (r1 :> 0 @@ r2 :> 1 @@ r3 :> 0 @@ r4 :> 0),unorderedRequest |-> (r1 :> {} @@ r2 :> {} @@ r3 :> {} @@ r4 :> {}),commitIndex |-> (r1 :> 0 @@ r2 :> 1 @@ r3 :> 1 @@ r4 :> 1)])
    >>
----
...
CONSTANTS
    ...
    Value <- const_174823799418924000
    Server <- const_174823799418925000
    MaxTerm <- const_174823799418926000
    MaxBecomeLeader <- const_174823799418927000
    MaxClientRequests <- const_174823799418928000
    Follower = Follower
    r1 = r1
    AppendEntriesRequest = AppendEntriesRequest
    r2 = r2
...
ALIAS
    _expression
=============================================================================
\* Generated on Mon May 26 07:42:34 CEST 2025